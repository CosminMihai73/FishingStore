...
<header class="header">
    ...
    <div class="w3-bar w3-light-green">
        ...
        <a href="fire.php" class ="w3-bar-item w3-button w3-mobile">Fire</a>
...
<div class="slideshow-container">
    <div class="mySlides fade">
        ...
        <img src="poze/slide1.jpg" style="width:100%">
    </div>

    <div class="mySlides fade">
        <div class="numbertext">2 / 3</div>
        <img src="poze/slide2.jpg" style="width:100%">
    </div>

    <div class="mySlides fade">
        <div class="numbertext">3 / 3</div>
        <img src="poze/slide3.jpg" style="width:100%">
    </div>
</div>
...
<footer>
    <div class="footer">
        <p>Contact: cosminmihaidaia@gmail.com</p>
    </div>
</footer>
